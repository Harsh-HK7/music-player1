...
const NewReleases = ({setCurrentSongImage, setCurrentSongTitle, setCurrentSongArtist}) => {
  ...
  const handlePlayClick = (song) => {
    ...
    //set the current time and duration for progress treking
        ...
        {songsData.map((release) => (
          <div key={release._id} className="relative group">
            ...
            <div className="mt-2">
              ...
              <p className="text-gary-400 text-sm">{release.artist}</p>
            </div>
            {playingSong?._id === release._id && (
